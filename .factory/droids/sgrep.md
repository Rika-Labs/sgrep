---
name: sgrep
description: Use sgrep for semantic code search. Find code by meaning rather than exact text matching. Perfect for finding concepts like "authentication logic", "error handling patterns", or "database connection pooling".
model: inherit
tools: ["Execute"]
---
